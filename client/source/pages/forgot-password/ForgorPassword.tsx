...
import { Button, ButtonGroup, Heading, Stack, Text, VStack } from "@chakra-ui/react";
        ...
        {!isSubmitSuccessful ? (
          <Stack spacing={10}>
            <VStack alignItems={"stretch"} textAlign={{ base: "left", sm: "center" }} spacing={6}>
              ...
              <Text color={"gray.500"}>
                No worries, enter the email associated with your account and we'll send you the instructions to reset
                your password.
              </Text>
            </VStack>
